" Vim syntax file
" Language:            Jspp
" Maintainer:          al1-ce <al1-ce@null.dev>
" Last Change:         03/06/2023
" Filenames:           *.jspp *.js++ *.jpp
...
syn keyword	csType	bool byte char decimal double float int long object sbyte short string uint ulong ushort var void dynamic function
syn keyword	csType	nint nuint " contextual

syn keyword	csStorage	enum interface namespace struct module
...
" Modifiers
syn match	csUsingModifier	"\<global\ze\_s\+import\>"
syn keyword	csAccessModifier	internal private protected public external
...
syn keyword	csUnspecifiedStatement	as in is nameof out params ref sizeof stackalloc using import
...
hi def link	csClassType	Identifier

...
local lines = {
    {
        chunks = {
            ...
            { text = "T O H A  H E A V Y  I N D U S T R I E S", hl = 'Special' }
        },
    },
    {
        chunks = {
            -- { text = string.format('Copyright (c) 2023 - %s developers', logo), hl = 'NonText' },
            { text = "Authority added " .. plugin_count() .. " entities to base reality", hl = "Tag" }
        },
    },
}

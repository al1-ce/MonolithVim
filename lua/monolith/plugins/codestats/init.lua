...
local json = require "monolith.utils.json"
-- Global variables
local utils =  require'monolith.plugins.codestats.utils'
local filetypes =  require'monolith.plugins.codestats.filetypes'
...
function M.setup(options)
  ...
  vim.api.nvim_command("augroup CodeStats")
    vim.api.nvim_command("autocmd InsertCharPre,TextChanged * lua require('monolith.plugins.codestats.init').insert_xp()")
    vim.api.nvim_command("autocmd VimLeavePre * lua require'monolith.plugins.codestats.init'.shutdown()")
...
function M.send_pulses()
  ...
  curl.post({
    ...
    callback = function(response)
      ...
      require('notify')("Could not send Code::Stats XP")
    end
  })
end

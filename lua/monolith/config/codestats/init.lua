...
-- Global variables
local utils =  require'monolith.config.codestats.utils'
local filetypes =  require'monolith.config.codestats.filetypes'
...
function M.setup(options)
  ...
  vim.api.nvim_command("augroup CodeStats")
    vim.api.nvim_command("autocmd InsertCharPre,TextChanged * lua require('monolith.config.codestats.init').insert_xp()")
    vim.api.nvim_command("autocmd VimLeavePre * lua require'monolith.config.codestats.init'.shutdown()")

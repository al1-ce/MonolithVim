...
local utils       = require("aft.codestats.utils")
local filetypes   = require("aft.codestats.types")
-- Global variables
...
function M.setup(options)
  ...
  vim.api.nvim_command("augroup CodeStats")
    vim.api.nvim_command("autocmd InsertCharPre,TextChanged * lua require('aft.codestats.setup').insert_xp()")
    vim.api.nvim_command("autocmd VimLeavePre * lua require('aft.codestats.setup').shutdown()")

...
-- Global variables
local utils =  require'utils.codestats.utils'
local filetypes =  require'utils.codestats.types'
...
function M.setup(options)
  ...
  vim.api.nvim_command("augroup CodeStats")
    vim.api.nvim_command("autocmd InsertCharPre,TextChanged * lua require('utils.codestats.init').insert_xp()")
    vim.api.nvim_command("autocmd VimLeavePre * lua require'utils.codestats.init'.shutdown()")
